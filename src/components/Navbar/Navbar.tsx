  ...
  return (
    <div className={`${styles.containerParent} ${isFixed ? styles.fixed : ""}`}>
      ...
      <div className={styles.containerChildren}>
        ...
        <Link className={styles.link} to="https://pharmacy.jiohealth.com/">
          {t("jio.pharmacy")}
        </Link>
        ...
        <div className={styles.translates}>
          <div
            ...
            style={{
              backgroundColor:
                selectedLanguage === "vi" ? "rgb(202 255 255)" : "transparent",
              padding: "10px",
              cursor: "pointer",
            }}>
            <img src={vi} />
          ...
          <div
            ...
            style={{
              backgroundColor:
                selectedLanguage === "en" ? "rgb(202 255 255)" : "transparent",
              padding: "10px",
              cursor: "pointer",
            }}>
            <span>EN</span>
