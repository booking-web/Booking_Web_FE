      ...
      <div className={styles.info}>
        ...
        <div className={styles.infos}>
          <div id={styles.infos} className={styles.info1}>
            ...
            <div className={styles.rightContent}>{item?.specialty}</div>
          </div>
          <div id={styles.infos} className={styles.info2}>
            <div className={styles.leftContent}>
              <img src={logo2} />
            </div>
            <div className={styles.rightContent}>{item?.trainingInstitution}</div>
          </div>
          <div id={styles.infos} className={styles.info3}>
            ...
            <div className={styles.rightContent}>
              {" "}
              <span style={{ fontWeight: "bold" }}>{item?.expYear}</span> {t("exp")}
            </div>
          </div>
        </div>
      </div>
