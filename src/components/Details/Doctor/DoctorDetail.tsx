        ...
        <div className={styles.contents}>
          <div className={styles.leftContent}>
            ...
            <div className={styles.description}>
              TS.BS Nguyễn Văn Sĩ có 15 năm kinh nghiệm khám chữa bệnh trong
              lĩnh vực Nội tổng quát và Nội tim mạch tại các bệnh viện lớn trong
              thành phố Hồ Chí Minh. BS Sĩ tốt nghiệp Tiến sĩ y khoa tại Đại học
              Yamanashi danh tiếng danh tiếng của Nhật Bản
            </div>
            <div className={styles.btns}>
              <button id={styles.btn} className={styles.btn1}>
                {t("book.clinic.visit")}
              </button>
              <button id={styles.btn} className={styles.btn2}>
                {t("book.home.visit")}
              </button>
            </div>
          </div>
        ...
        <div className={styles.contents}>
          <div>
            ...
            <div className={styles.info}>
              ...
              lĩnh vực Nội tổng quát và Nội tim mạch tại các bệnh viện lớn trong
              thành phố Hồ Chí Minh. BS Sĩ tốt nghiệp Tiến sĩ y khoa tại Đại học
              Yamanashi danh tiếng của Nhật Bản và có nhiều công trình nghiên
              cứu y học công bố trên các tạp chí khoa học uy tín trong và ngoài
              nước. Hiện tại BS Sĩ là Giảng viên Bộ môn Nội tổng quát, Đại học Y
              Dược Thành phố Hồ Chí Minh và là cố vấn Nội khoa tại Jio Health.
            </div>
          </div>
        </div>
      </div>
